...
\begin{align*}
  ...
  {dan} &\vdash CONJ: \lambda x.\lambda y.\lambda f.\lambda z.\ ((f\ x)\ z) \land ((f\ y)\ z)\\
  {menyukai} &\vdash (S{\backslash}NP)/NP: \lambda x.\lambda y.\ suka(x, y)\\
...
\begin{center}
  ...
  \tabbedShortstack{
    ...
    !^{$NP$} & &
      ...
      !^{$NP$} &\\
    !{*: \so{pamungkas}} & &
      !{*: $\lambda x.\lambda y.\lambda f.\lambda z.\ ((f\ x)\ z) \land ((f\ y)\ z)$} & &
      !{*: \so{setyo}} & &
      !{*: $\lambda x.\lambda y.\ suka(x, y)$} & &
      !{*: \so{rendang}} &
  }
  \egroup
\end{center}
...
dan \textit{backward application}. Kita dapatkan:
...
\begin{center}
  ...
  \tabbedLongunderstack{
    ...
    \TABrule & \TABrule &
      ...
      &\\
    & &
      ?{^{$NP$}{*: $\lambda f. \lambda z.\ ((f\ \so{pamungkas})\ z) \land ((f\ \so{setyo})\ z)$}}
      \ \ \ \ \ \ \ 
      & & & & & & & & & &\\
    \TABrule & \TABrule &
      \TABrule & \TABrule &
    ...
    & &
      \ \ \ \ \ \ \ \ \ \ \ 
      ?{^{$(S\backslash NP)$}{*: $\lambda z.\ ((\lambda y.\ suka(\so{pamungkas}, y))\ z) \land
        ((\lambda y.\ suka(\so{setyo}, y)\ z))$}}
      & & & & & & & & & &\\
    \TABrule & \TABrule &
      \TABrule & \TABrule &
      \TABrule & \TABrule &
    ...
    & &
      \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ 
      ?{^{$S$}{*: $suka(\so{pamungkas}, \so{rendang}) \land suka(\so{setyo}, \so{rendang})$}}
      & & & & & & & & & &
  }
  \egroup
\end{center}
